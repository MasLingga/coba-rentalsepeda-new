...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../"/>
		<title>Selamat Datang di Rental Sepeda Online</title>
		<meta charset="utf-8" />
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('{{ url("template") }}/assets/media/auth/sepeda-lipat.jpg'); } [data-bs-theme="dark"] body { background-image: url('{{ url("template") }}/assets/media/auth/sepeda-lipat.jpg'); }</style>
			<!--end::Page bg image-->
			...
			<div class="d-flex flex-column flex-column-fluid flex-lg-row">
				...
				<div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
					...
					<div class="d-flex flex-center flex-lg-start flex-column">
						...
						<!--end::Logo-->
						<!--begin::Title-->
						<h4 class="text-black fw-bold m-0" >Rental Sepeda</h4>
						<img alt="Logo" src="{{ url("template") }}/assets/media/logos/bike-logo1.jpg" width=250px />
